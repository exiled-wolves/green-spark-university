-- PostgreSQL Migration for Green Spark University
...
-- --------------------------------------------------------
-- Table: academic_sessions (no dependencies)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: applicants (depends on departments)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: lecturers (depends on departments)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: students (depends on applicants, departments)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: course_assignments (depends on courses, lecturers)
-- --------------------------------------------------------
...
CREATE INDEX idx_course_assignments_lecturer ON course_assignments(lecturer_id);

-- --------------------------------------------------------
-- Table: course_registrations (depends on students, courses)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: results (depends on students, courses, lecturers)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: complaints (polymorphic - sender can be student or lecturer)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: leave_applications (depends on lecturers)
-- --------------------------------------------------------
...
CREATE INDEX idx_leave_applications_lecturer ON leave_applications(lecturer_id);

-- --------------------------------------------------------
-- Table: notifications (polymorphic recipient)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table: student_reports (depends on lecturers, students, courses)
-- --------------------------------------------------------
...
CREATE INDEX idx_student_reports_lecturer ON student_reports(lecturer_id);
CREATE INDEX idx_student_reports_student ON student_reports(student_id);
CREATE INDEX idx_student_reports_course ON student_reports(course_id);
